...
module Foreign.Hoppy.Example.Std (
  StdStringValue (..),
  StdStringConstPtr (..),
  stdString_get,
  stdString_c_str,
...
stdString_data :: (StdStringValue arg'1) => arg'1 -> HoppyP.IO (HoppyF.Ptr HoppyFC.CChar)
...
stdString_at :: (StdStringPtr arg'1) => arg'1 -> HoppyP.Int -> HoppyP.IO (HoppyF.Ptr HoppyFC.CChar)
